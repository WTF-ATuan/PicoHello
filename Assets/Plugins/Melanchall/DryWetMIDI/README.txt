...
DryWetMIDI 6.1.0 by Melanchall
...
Please take a look at Demo folder of the package where sample sample scene placed along with sample script using DryWetMIDI.