...
namespace FIMSpace.FLook
{
    ...
    {
        private TextAsset langFile { get { if (_langFile == null) _langFile = Resources.Load("Look Animator/LookAnimator_Langs") as TextAsset; return _langFile; } }
        ...
        private void SetupLangs()
        {
            ...
            choosedLang = (ELangs)PlayerPrefs.GetInt("FLookAnimLang", 0);

            if (langFile == null)
            {
                Debug.Log("[Look Animator] No Lang file! You moved it from Editor/Resources/Look Animator/ ???");
                return;
            }
        ...
        {
            if (langTexts == null) return title;
