Shader "GGDog/Effect/SpiritLink_Guides"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half WaterTex(half2 uv,half2 Tilling,half FlowSpeed)
            {
                ...
                UV = frac(uv.xy*1+Time*1.34* half2(0.54,-0.1));
                UV_Center = (UV.x-0.5)*(UV.x-0.5)+(UV.y-0.5)*(UV.y-0.5);
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half w = WaterTex(i.uv,half2(_NoiseTilingX,_NoiseTilingY),1) + WaterTex(i.uv,half2(_NoiseTilingX,_NoiseTilingY),-1);
