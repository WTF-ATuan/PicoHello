Shader "GGDog/CameraEffect/Injured"
{
    Properties
    {
        ...
        _Dis ("Dis", Range(0.00235,0.005)) = 0.00235
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float n =7* _Dis* saturate(snoise(2000*float2(2,2)*i.worldPos.xy/1000+_Time.y*float2(0,1.25)) + snoise(2000*float2(5,5)*i.worldPos.xy/1000-_Time.y*float2(0,1)));


				float fade =(i.uv.y+_Dis*(_OriScale+100))/_OriScale-0.05 ;
