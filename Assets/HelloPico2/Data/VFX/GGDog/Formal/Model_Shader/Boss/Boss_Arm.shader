    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float4 FinalColor = lerp(_ShadowColor + BackRimColor*smoothstep(0,0.25,i.uv.y),_Color + DirRimColor*smoothstep(0,0.25,i.uv.y)  ,NdotL ) +Specular*saturate(BackRimColor*3.5);
