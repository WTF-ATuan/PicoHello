	...
	SubShader
	{
		...
		Pass
		{
			...
			struct v2f
			{
                ...
                fixed WNdotWL : TEXCOORD4;
                fixed Rim_Direct : TEXCOORD5;
                fixed Rim_Reverse : TEXCOORD6;
			...
			v2f vert (appdata v)
			{
				...
				o.WNdotWL = dot(worldNormal,worldLightDir);

				fixed ViewDirDOTNormal = dot(worldViewDir,worldNormal);
				o.Rim_Direct = pow( saturate( 0.5 + o.WNdotWL) * ( 1.15-ViewDirDOTNormal )*_RimLight_Direct ,_Rim_Direct_Pow); //正邊緣光
				o.Rim_Reverse = pow( saturate( 0.5 - o.WNdotWL) * ( 1-ViewDirDOTNormal ) *_RimLight_Reverse ,_Rim_Reverse_Pow); //反邊緣光
			...
			/*   主體色   */
				...
				fixed Shading =  smoothstep( 0 , _LightGradient,i.WNdotWL  + _LightGradient/5    ) ;
			...
			/*   正反邊緣光處理   */
				...
				col = lerp(col,_RimColor_Direct,i.Rim_Direct*_RimColor_Direct.a);
				col = lerp(col,_RimColor_Reverse,i.Rim_Reverse*_RimColor_Reverse.a);
