Shader "Unlit/Glass"
{
    Properties
    {
		...
		[HDR]_LiquidColor ("LiquidColor",Color) = (0.5,0.5,0.5,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
				...
				half3 worldNormal = 1/normalize(i.worldNormal);
               ...
               // half4 FinalColor = Liquid + half4(1,1,1,Rim);
                
                _LiquidColor = lerp(_LiquidColor2,_LiquidColor,smoothstep(-0.025,0,Y));

                half4 FinalColor = lerp( half4(_GlassColor.rgb,(Rim+specular)*0.25),_LiquidColor, Liquid*_LiquidColor.a);
