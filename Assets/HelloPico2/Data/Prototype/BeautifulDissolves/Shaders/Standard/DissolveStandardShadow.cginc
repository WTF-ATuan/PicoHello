...
void dissolveVertShadowCaster (VertexInput v
...
half4 dissolveFragShadowCaster (UNITY_POSITION(vpos)
#ifdef UNITY_STANDARD_USE_SHADOW_OUTPUT_STRUCT
...
) : SV_Target
{
        ...
        #ifndef _SUBMAP
			half dissolveMask = DissolveMask(i.tex.xy);
			// an amount <= 0 will be dissolved
			half dissolve = DissolveMapFactor(i.tex.xy) * dissolveMask;
			clip(dissolve - 0.001);
		#endif
