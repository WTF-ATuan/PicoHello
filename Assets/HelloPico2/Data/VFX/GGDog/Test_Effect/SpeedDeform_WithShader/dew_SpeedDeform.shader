	...
	SubShader
	{
		...
		{	
			...
			v2f vert (appdata v)
			{
				...
				o.vertex = UnityObjectToClipPos(v.vertex + v.normal * pow((Noise1+Noise2+Noise3)*uvdis/2,2)   +  (_SpeedDir.xyz)*(dot((_SpeedDir.xyz),(o.worldNormal))-1) );
			...
			half4 frag (v2f i) : SV_Target
			{
               ...
               // half3 worldLightDir = normalize(_WorldSpaceLightPos0.xyz);
				...
				Specular = smoothstep(0,0.001,Specular) + smoothstep(0.49,0.5,Specular_Bottom);
