...
{
	internal class UIDissolveShaderGUI : ShaderGUI
	{
		private static class Styles
		{
			...
			public static GUIContent stencilComparisonText = new GUIContent("Stencil Comparison", "");
			public static GUIContent stencilIDText = new GUIContent("Stencil ID", "");
			public static GUIContent stencilOperationText = new GUIContent("Stencil Operation", "");
		...
		MaterialProperty stencilComparison = null;
		MaterialProperty stencilID = null;
		MaterialProperty stencilOperation = null;
		...
		public void FindProperties (MaterialProperty[] props)
		{
			...
			stencilComparison = FindProperty ("_StencilComp", props);
			stencilID = FindProperty ("_Stencil", props);
			stencilOperation = FindProperty ("_StencilOp", props);
		...
		public virtual void DoAlbedoArea()
		{
			...
			m_MaterialEditor.ShaderProperty (stencilComparison, Styles.stencilComparisonText.text);
			m_MaterialEditor.ShaderProperty (stencilID, Styles.stencilIDText.text);
			m_MaterialEditor.ShaderProperty (stencilOperation, Styles.stencilOperationText.text);
