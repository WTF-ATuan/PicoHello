	...
	SubShader
	{
		...
		{	
			...
			v2f vert (appdata v)
			{
				...
				float Noise1 = snoise(v.vertex*0.1+_Time.y*(0.35,-0.25)*7.5);
				float Noise2 = snoise(v.vertex*0.1+_Time.y*(-0.15,0.45)*5.5);

				float noise = (Noise1*0.75+Noise2*0.5);
			...
			half4 frag (v2f i) : SV_Target
			{
				...
				half CameraDistance950_1500 =  saturate(smoothstep(70,500,i.CameraDistance));
					 CameraDistance950_1500 *=  1-saturate(smoothstep(70,100,CameraDistance950_1500));
